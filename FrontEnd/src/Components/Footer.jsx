  ...
  return (
    <footer className="bg-gray-100 text-black py-10">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col items-center mb-6 md:mb-0">
          ...
          <div className="flex justify-center space-x-6 mt-4">
            <a href="https://github.com/Ashutosh-Shukla-036" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <FaGithub className="text-2xl text-black hover:text-blue-500 transition" />
            </a>
        ...
        <div className="text-center mb-6 md:mb-0">
          ...
          <p className="mb-1">
            ...
            <br />
            <a href="mailto:ashutoshshukla8970@gmail.com" className="text-blue-400 hover:text-blue-300 transition">ashutoshshukla8970@gmail.com</a>
          </p>
          <p>
        ...
        <div className="text-center mb-6 md:mb-0">
          ...
          <Link to="/contact" className="text-blue-500 hover:text-blue-400 transition">
            Get in Touch
          </Link>
        </div>
      </div>
      ...
      <div className="text-center mb-6">
        <Link to="/about" className="text-blue-500 hover:text-blue-400 transition">About Me</Link> 
      </div>

...
const About = () => {
  return (
    <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-8">
      {/* Left Column */}
      <div className="flex flex-col shadow-lg transition-shadow duration-300 hover:shadow-xl rounded-lg p-6 bg-white dark:bg-gray-800">
        <h1 className="text-4xl font-bold mb-6 text-gray-800 dark:text-white">About Me</h1>
        <h2 className="text-3xl font-semibold mb-4 text-gray-800 dark:text-white">Hello! I'm Ashutosh Shukla</h2>
        ...
        <h3 className="text-2xl font-semibold mb-2 text-gray-800 dark:text-white">Background</h3>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
      ...
      <div className="flex flex-col shadow-lg transition-shadow duration-300 hover:shadow-xl rounded-lg p-6 bg-white dark:bg-gray-800">
        ...
        <h3 className="text-2xl font-semibold mb-2 text-gray-800 dark:text-white">My Vision</h3>
        <p className="mb-4 text-gray-700 dark:text-gray-300">
        ...
        <h3 className="text-2xl font-semibold mb-2 text-gray-800 dark:text-white">Let's Connect!</h3>
